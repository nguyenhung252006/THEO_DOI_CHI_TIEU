...
//import component
import LocChiTieuTheoNgay from "../../Component_chung/LocChiTieu/LocChiTieuTheoNgay";
import LocChiTieuTheoNam from "../../Component_chung/LocChiTieu/LocChiTieuTheoNam";
import LocChiTieuTheoMin from "../../Component_chung/LocChiTieu/LocChiTieuTheoMin";
import LocChiTieuTheoMax from "../../Component_chung/LocChiTieu/LocChiTieuTheoMax";
import LocChiTieuTheoGhiChu from "../../Component_chung/LocChiTieu/LocChiTieuTheoGhiChu";
        ...
        <>
            <div className={cx('wrapper')} ref={wrapperRef}>
                {isSelect && <div className={cx('wrapper-select')}>
                    ...
                    <p onClick={() => { handleGhiChu() }}>Ghi chú</p>
                </div>}
